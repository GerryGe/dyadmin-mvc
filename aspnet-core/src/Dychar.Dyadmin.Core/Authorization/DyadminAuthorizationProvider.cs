...
{
    public class DyadminAuthorizationProvider : AuthorizationProvider
    {

        private readonly bool _isMultiTenancyEnabled;

        public DyadminAuthorizationProvider(bool isMultiTenancyEnabled)
        {
            _isMultiTenancyEnabled = isMultiTenancyEnabled;
        }

        public DyadminAuthorizationProvider(IMultiTenancyConfig multiTenancyConfig)
        {
